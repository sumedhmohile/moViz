...
function LanguageRevenueBudgetPopularity() {
    ...
    useEffect(() => {
      ...
      fetchGraphData(xDataSetter, yDataSetter, languageDataSetter, popularityDataSetter);
    }, []);
    ...
    return (
             <Plot
             data={plotData}
             layout={ {width: 600, height: 750, title: 'Impact of language on Popularity, Budget and Revenue', yaxis: {title: 'Revenue'}, xaxis: {title: 'Budget'} }}
           />
