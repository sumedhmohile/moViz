...
const URL = "http://ec2-3-19-241-187.us-east-2.compute.amazonaws.com:8000/api/movieTopTenByVector/";
...
title={ data.title }
description={ "Moviz Score: " + data.value }
...
export default TopVectorMovies;