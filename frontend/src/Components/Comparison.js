...
function fetchRevenueGraphData(actor1, actor2,
                        actor1GenreSetter, actor1RevenueSetter, actor2GenreSetter, actor2RevenueSetter, combinedGenreSetter, combinedRevenueSetter) {
    const article1 = { graphID: 'avgRevenueByGenreForActor', graphData: { actor:actor1 } };
        axios.post(URL, article1)
            .then(response => {
    ...
    const article2 = { graphID: 'avgRevenueByGenreForActor', graphData: { actor:actor2 } };
            axios.post(URL, article2)
                .then(response => {
                    console.log(response.data);
...
//                    console.log(actor2);
    ...
    const article3 = { graphID: 'avgRevenueByGenreForActors', graphData: { actor1:actor1, actor2:actor2 } };
                axios.post(URL, article3)
                    .then(response => {
                        console.log(response.data);
...
function fetchBudgetGraphData(actor1, actor2, budgetactor1GenreSetter, budgetactor1RevenueSetter, budgetactor2GenreSetter, budgetactor2RevenueSetter, budgetcombinedGenreSetter, budgetcombinedRevenueSetter) {
const article1 = { graphID: 'avgBudgetByGenreForActor', graphData: { actor:actor1 } };
        axios.post(URL, article1)
            .then(response => {
                console.log(response.data);
    ...
    const article2 = { graphID: 'avgBudgetByGenreForActor', graphData: { actor:actor2 } };
            axios.post(URL, article2)
                .then(response => {
                    console.log(response.data);
...
//                    console.log(actor2);
    ...
    const article3 = { graphID: 'avgBudgetByGenreForActors', graphData: { actor1:actor1, actor2:actor2 } };
                axios.post(URL, article3)
                    .then(response => {
                        console.log(response.data);
...
function createGraphs(actor1Input, actor2Input,
                        actor1GenreSetter, actor1RevenueSetter, actor2GenreSetter, actor2RevenueSetter, combinedGenreSetter, combinedRevenueSetter,
                        budgetactor1GenreSetter, budgetactor1RevenueSetter, budgetactor2GenreSetter, budgetactor2RevenueSetter, budgetcombinedGenreSetter, budgetcombinedRevenueSetter)
                        {
    console.log("A1: " + actor1Input);
    console.log("A2: " + actor2Input);
    fetchRevenueGraphData(actor1Input, actor2Input, actor1GenreSetter, actor1RevenueSetter, actor2GenreSetter, actor2RevenueSetter, combinedGenreSetter, combinedRevenueSetter);
    fetchBudgetGraphData(actor1Input, actor2Input, budgetactor1GenreSetter, budgetactor1RevenueSetter, budgetactor2GenreSetter, budgetactor2RevenueSetter, budgetcombinedGenreSetter, budgetcombinedRevenueSetter);
...
function Comparison() {
    ...
    <div>
    <div>
        <input type='text' placeholder='Actor1' value={actor1Input} onInput={e => setActor1Input(e.target.value)}></input>
        <input type='text' placeholder='Actor2' value={actor2Input} onInput={e => setActor2Input(e.target.value)}></input>
        <button onClick={() => createGraphs(actor1Input, actor2Input,
                                            actor1GenreSetter, actor1RevenueSetter, actor2GenreSetter, actor2RevenueSetter, combinedGenreSetter, combinedRevenueSetter,
                                            budgetactor1GenreSetter, budgetactor1RevenueSetter, budgetactor2GenreSetter, budgetactor2RevenueSetter, budgetcombinedGenreSetter, budgetcombinedRevenueSetter
