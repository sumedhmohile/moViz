...
function TopBudgetMovies(props){

const [userData,setUserData]=useState([]);
const URL = "http://ec2-3-19-241-187.us-east-2.compute.amazonaws.com:8000/api/movieTopTenByBudget/";
...
export default TopBudgetMovies;